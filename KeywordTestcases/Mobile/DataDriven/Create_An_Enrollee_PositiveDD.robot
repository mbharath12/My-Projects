*** Settings ***
Test Template     Create An Enrollee Positive
Library           DataDriver    ../../../Testdata/DataDriver.xlsx    sheet_name=EnroleeCreationPositive
...
Create An Enrollee Positive
    ...
    Comment    validate toast msg    Enrollee Saved
    Comment    Verify same page is displayed    Add Enrollee
