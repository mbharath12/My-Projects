...
const configurePaymentProcessorJson = JSON.parse(open('./24_configure_payment_processor_json.json'));
...
export const options = {
    ...
    ext: {
        loadimpact: {
          ...
          name: "24_configure_payment_processor.js",
            distribution: {
                'amazon:us:ashburn': {
...
// Configure Payment Processor Params define
    ...
    check(configurePaymentProcessorResponse, {
        ...
        'Configure payment Processor Name validated': (res) => res.json("payment_processor_name") === 'MODERN_TREASURY',
