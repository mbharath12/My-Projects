...
const configurePaymentProcessorJson = JSON.parse(open('./26_configure_payment_processor_dwolla_json.json'));
...
export const options = {
    ...
    ext: {
        loadimpact: {
          ...
          name: "26_configure_payment_processor_dwolla.js",
            distribution: {
                'amazon:us:ashburn': {
...
// Configure Payment Processor Params define
    ...
    check(configurePaymentProcessorResponse, {
        ...
        'Configure payment Processor Name validated': (res) => res.json("payment_processor_name") === 'DWOLLA',
