    ...
    thresholds: {
     ...
     ext: {
        loadimpact: {
          ...
          name: "15_get_a_credit_report.js",
            distribution: {
                'amazon:us:ashburn': {
...
export default function() {
    ...
    // #####Get a credit report request start#####// 

  
  
    // get credit report URL 
    let getCreditReportUrl = data.accountsUrl + "/" + sequenceUser['accountId'] + "/credit_reports/" + sequenceUser['reportId'];

    //Get get credit report headers
    ...
    check(getCreditReportResponse, {
        'Get Credit Report Response is 200': (res) => res.status == 200,
