...
public class TS17VerifyButtonsinEditor {
	...
	public void test() throws IOException{
		...
		for(int index = 1;index <= mapAllDetails.size();index++){
			...
			if(mapquestionsDetails.get("Functionality") !=null && mapquestionsDetails.get("Functionality").equalsIgnoreCase("Verify Buttons in Editor")) {
				...
				bstatus = ApplicationFunctions.doVerifyButtonsinEditor(mapquestionsDetails);
