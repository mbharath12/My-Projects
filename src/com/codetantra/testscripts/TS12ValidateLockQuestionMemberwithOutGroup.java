...
public class TS12ValidateLockQuestionMemberwithOutGroup {
	...
	public void test() throws IOException{
		...
		for(int index = 1;index <= mapAllDetails.size();index++){
			...
			if(mapquestionsDetails.get("Functionality") !=null && mapquestionsDetails.get("Functionality").equalsIgnoreCase("Member Not In group")) {
			...
			test.log(Status.INFO, MarkupHelper.createLabel("Login in to Application", ExtentColor.GREEN)).pass("Login in to Application Successfully");
				...
				bstatus = ApplicationFunctions.doVerifyLockSystemAsNotMemberOfGroup();
