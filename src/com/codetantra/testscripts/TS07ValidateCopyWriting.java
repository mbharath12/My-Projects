...
public class TS07ValidateCopyWriting {
	...
	public void test() throws IOException{
		...
		for(int index = 1;index <= mapAllDetails.size();index++){
			...
			if(mapquestionsDetails.get("Functionality") !=null && mapquestionsDetails.get("Functionality").equalsIgnoreCase("Copy Writing")) {
			...
			itr=itr+1;
				...
				bstatus = ApplicationFunctions.doValidateCopyWriteCourses(mapquestionsDetails);
