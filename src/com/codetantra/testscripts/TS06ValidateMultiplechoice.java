...
public class TS06ValidateMultiplechoice {
	...
	public void test() throws IOException{
		...
		for(int index = 1;index <= mapAllDetails.size();index++){
			...
			if(mapquestionsDetails.get("Functionality") !=null && mapquestionsDetails.get("Functionality").equalsIgnoreCase("Multiple choice Multiple Answers") || mapquestionsDetails.get("Functionality").equalsIgnoreCase("Multiple choice Single Answers")) {
				...
				//bstatus = ApplicationFunctions.doValidateMultiplechoiceQuestion(mapquestionsDetails);
